...
/* package hasktorch-raw-tests-0.0.1.0 */
#ifndef VERSION_hasktorch_raw_tests
#define VERSION_hasktorch_raw_tests "0.0.1.0"
#endif /* VERSION_hasktorch_raw_tests */
#ifndef MIN_VERSION_hasktorch_raw_tests
#define MIN_VERSION_hasktorch_raw_tests(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 1)
#endif /* MIN_VERSION_hasktorch_raw_tests */
...
#define CURRENT_PACKAGE_KEY "hasktorch-raw-tests-0.0.1.0-inplace"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "hasktorch-raw-tests-0.0.1.0-inplace"
